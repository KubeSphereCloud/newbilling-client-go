...
// NewNotifierCreateEventParams creates a new NotifierCreateEventParams object,
...
func NewNotifierCreateEventParams() *NotifierCreateEventParams {
	return &NotifierCreateEventParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewNotifierCreateEventParamsWithTimeout creates a new NotifierCreateEventParams object
...
// NewNotifierCreateEventParamsWithContext creates a new NotifierCreateEventParams object
...
// NewNotifierCreateEventParamsWithHTTPClient creates a new NotifierCreateEventParams object
...
func (o *NotifierCreateEventParams) WithDefaults() *NotifierCreateEventParams {
	o.SetDefaults()
	return o
}
...
func (o *NotifierCreateEventParams) WithTimeout(timeout time.Duration) *NotifierCreateEventParams {
...
func (o *NotifierCreateEventParams) WithContext(ctx context.Context) *NotifierCreateEventParams {
	o.SetContext(ctx)
	return o
}
...
func (o *NotifierCreateEventParams) WithBody(body *models.NewbillingCreateEventRequest) *NotifierCreateEventParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the notifier create event params
func (o *NotifierCreateEventParams) SetBody(body *models.NewbillingCreateEventRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *NotifierCreateEventParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
