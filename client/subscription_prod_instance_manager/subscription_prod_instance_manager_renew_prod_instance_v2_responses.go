...
func (o *SubscriptionProdInstanceManagerRenewProdInstanceV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSubscriptionProdInstanceManagerRenewProdInstanceV2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewSubscriptionProdInstanceManagerRenewProdInstanceV2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewSubscriptionProdInstanceManagerRenewProdInstanceV2OK() *SubscriptionProdInstanceManagerRenewProdInstanceV2OK {
	return &SubscriptionProdInstanceManagerRenewProdInstanceV2OK{}
}
...
func (o *SubscriptionProdInstanceManagerRenewProdInstanceV2OK) Error() string {
	return fmt.Sprintf("[POST /v2/prodinstances/{prod_inst_id_ext}:renew][%d] subscriptionProdInstanceManagerRenewProdInstanceV2OK  %+v", 200, o.Payload)
}
...
func (o *SubscriptionProdInstanceManagerRenewProdInstanceV2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NewbillingRenewProdInstanceV2Response)
...
func NewSubscriptionProdInstanceManagerRenewProdInstanceV2Default(code int) *SubscriptionProdInstanceManagerRenewProdInstanceV2Default {
	return &SubscriptionProdInstanceManagerRenewProdInstanceV2Default{
		_statusCode: code,
	}
}
...
func (o *SubscriptionProdInstanceManagerRenewProdInstanceV2Default) Error() string {
	return fmt.Sprintf("[POST /v2/prodinstances/{prod_inst_id_ext}:renew][%d] SubscriptionProdInstanceManager_RenewProdInstanceV2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *SubscriptionProdInstanceManagerRenewProdInstanceV2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
