...
// NewChargingManagerPaymentCallbackParams creates a new ChargingManagerPaymentCallbackParams object,
...
func NewChargingManagerPaymentCallbackParams() *ChargingManagerPaymentCallbackParams {
	return &ChargingManagerPaymentCallbackParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewChargingManagerPaymentCallbackParamsWithTimeout creates a new ChargingManagerPaymentCallbackParams object
...
// NewChargingManagerPaymentCallbackParamsWithContext creates a new ChargingManagerPaymentCallbackParams object
...
// NewChargingManagerPaymentCallbackParamsWithHTTPClient creates a new ChargingManagerPaymentCallbackParams object
...
func (o *ChargingManagerPaymentCallbackParams) WithDefaults() *ChargingManagerPaymentCallbackParams {
	o.SetDefaults()
	return o
}
...
func (o *ChargingManagerPaymentCallbackParams) WithTimeout(timeout time.Duration) *ChargingManagerPaymentCallbackParams {
...
func (o *ChargingManagerPaymentCallbackParams) WithContext(ctx context.Context) *ChargingManagerPaymentCallbackParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the charging manager payment callback params
func (o *ChargingManagerPaymentCallbackParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the charging manager payment callback params
func (o *ChargingManagerPaymentCallbackParams) WithHTTPClient(client *http.Client) *ChargingManagerPaymentCallbackParams {
...
func (o *ChargingManagerPaymentCallbackParams) WithBody(body *models.NewbillingPaymentCallbackRequest) *ChargingManagerPaymentCallbackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the charging manager payment callback params
func (o *ChargingManagerPaymentCallbackParams) SetBody(body *models.NewbillingPaymentCallbackRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *ChargingManagerPaymentCallbackParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
