...
func (o *PaymentPrepayWxpayNativeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPaymentPrepayWxpayNativeOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewPaymentPrepayWxpayNativeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPaymentPrepayWxpayNativeOK() *PaymentPrepayWxpayNativeOK {
	return &PaymentPrepayWxpayNativeOK{}
}
...
func (o *PaymentPrepayWxpayNativeOK) Error() string {
	return fmt.Sprintf("[POST /v1/prepay/wxpay/native][%d] paymentPrepayWxpayNativeOK  %+v", 200, o.Payload)
}
...
func (o *PaymentPrepayWxpayNativeOK) GetPayload() *models.NewbillingPrepayWxpayNativeResponse {
	return o.Payload
}

func (o *PaymentPrepayWxpayNativeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NewbillingPrepayWxpayNativeResponse)
...
func NewPaymentPrepayWxpayNativeDefault(code int) *PaymentPrepayWxpayNativeDefault {
	return &PaymentPrepayWxpayNativeDefault{
		_statusCode: code,
	}
}
...
func (o *PaymentPrepayWxpayNativeDefault) Code() int {
...
func (o *PaymentPrepayWxpayNativeDefault) Error() string {
	return fmt.Sprintf("[POST /v1/prepay/wxpay/native][%d] Payment_PrepayWxpayNative default  %+v", o._statusCode, o.Payload)
}

func (o *PaymentPrepayWxpayNativeDefault) String() string {
	return fmt.Sprintf("[POST /v1/prepay/wxpay/native][%d] Payment_PrepayWxpayNative default  %+v", o._statusCode, o.Payload)
}

func (o *PaymentPrepayWxpayNativeDefault) GetPayload() *models.RuntimeError {
	return o.Payload
}

func (o *PaymentPrepayWxpayNativeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
