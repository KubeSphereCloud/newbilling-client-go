...
func (m *NewbillingCreateOrUpdateCustomerRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NewbillingCreateOrUpdateCustomerRequest) validateCustomers(formats strfmt.Registry) error {
...
func (m *NewbillingCreateOrUpdateCustomerRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewbillingCreateOrUpdateCustomerRequest) contextValidateCustomers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NewbillingCreateOrUpdateCustomerRequest) UnmarshalBinary(b []byte) error {
	var res NewbillingCreateOrUpdateCustomerRequest
