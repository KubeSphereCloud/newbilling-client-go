...
func (m *NewbillingPushCollectDataRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NewbillingPushCollectDataRequest) validateEvents(formats strfmt.Registry) error {
...
func (m *NewbillingPushCollectDataRequest) contextValidateEvents(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NewbillingPushCollectDataRequest) UnmarshalBinary(b []byte) error {
	var res NewbillingPushCollectDataRequest
