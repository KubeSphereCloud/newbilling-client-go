...
func (m *NewbillingFilterInfo) validateFilter(formats strfmt.Registry) error {
...
func (m *NewbillingFilterInfo) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
