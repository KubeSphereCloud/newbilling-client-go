...
func (m *NewbillingProdIDAndCode) validatePlans(formats strfmt.Registry) error {
...
func (m *NewbillingProdIDAndCode) contextValidatePlans(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NewbillingProdIDAndCode) UnmarshalBinary(b []byte) error {
	var res NewbillingProdIDAndCode
