...
func (m *NewbillingCreateProductRequest) validateEffectiveTime(formats strfmt.Registry) error {
...
func (m *NewbillingCreateProductRequest) validateExpirationTime(formats strfmt.Registry) error {
...
func (m *NewbillingCreateProductRequest) UnmarshalBinary(b []byte) error {
	var res NewbillingCreateProductRequest
