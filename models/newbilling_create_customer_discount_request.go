...
func (m *NewbillingCreateCustomerDiscountRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NewbillingCreateCustomerDiscountRequest) validateEffectiveTime(formats strfmt.Registry) error {
...
func (m *NewbillingCreateCustomerDiscountRequest) validateExpirationTime(formats strfmt.Registry) error {
...
func (m *NewbillingCreateCustomerDiscountRequest) validateFiltersMapList(formats strfmt.Registry) error {
...
func (m *NewbillingCreateCustomerDiscountRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewbillingCreateCustomerDiscountRequest) contextValidateFiltersMapList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NewbillingCreateCustomerDiscountRequest) UnmarshalBinary(b []byte) error {
	var res NewbillingCreateCustomerDiscountRequest
